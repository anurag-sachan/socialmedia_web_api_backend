...
import com.app.socialmedia_api.entities.Post;
...
import com.app.socialmedia_api.repositories.PostRepo;
...
public class PostServiceImpl implements PostService {
	...
	public PostResponse getAllPost(Integer pageNumber, Integer pageSize, String sortBy) {
		...
		org.springframework.data.domain.Pageable p=PageRequest.of(pageNumber, pageSize, org.springframework.data.domain.Sort.by(sortBy).ascending());
